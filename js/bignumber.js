 ...
 */
    ...
    var BigNumber, isNumeric = /^-?(?:\d+(?:\.\d*)?|\.\d+)(?:e[+-]?\d+)?$/i, mathceil = Math.ceil, mathfloor = Math.floor,
    bignumberError = '[BigNumber Error] ', tooManyDigits = bignumberError + 'Number primitive has more than 15 significant digits: ',
    BASE = 1e14, LOG_BASE = 14, MAX_SAFE_INTEGER = 0x1fffffffffffff, // 2^53 - 1
        ...
        function BigNumber(v, b) {
            ...
            if (b == null) {
                ...
                if ((isNum = typeof v == 'number') && v * 0 == 0) {
                    ...
                    x.s = str.charCodeAt(0) == 45 ? (str = str.slice(1),
                    -1) : 1;
                }
     ...
     */
       ...
       */
            ...
            return function(str, baseIn, baseOut, sign, callerIsToString) {
                ...
                xc = toBaseOut(str, baseIn, baseOut, callerIsToString ? (alphabet = ALPHABET,
